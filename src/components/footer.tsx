                ...
                <div className="footer-col-4">
                    ...
                    <div className="footer-contact-info">
                        ...
                        <div className="contact-row">
                            ...
                            <span>
                                <strong style={{ color: '#f5c46a' }}>Puducherry Address:</strong> R.S.No. 127/1/A/1, Arumpathapuram, Villianur Main Road, V.I.P. Nagar, Oulgaret Revenue Village, Oulgarat Municipality, Puducherry - 605110.
                            </span>
                        </div>
